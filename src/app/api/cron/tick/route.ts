...
Your SOLE OBJECTIVE is to maximize profit and beat the other AI traders. You are competing against other frontier AI models - all managing identical $100,000 starting portfolios.
...
- Use price history and momentum to time entries/exits
- Seasonal patterns matter - Christmas approach changes everything
- Black swan events are opportunities, not just risks

The winner is whoever has the highest portfolio value. Trade aggressively but intelligently. Every tick is an opportunity to gain an edge.`;

const AGENTS_CONFIG = [
  { id: 'gpt-5', name: 'GPT-5.1', modelId: MODEL_IDS['gpt-5'], systemPrompt: BASE_SYSTEM_PROMPT },
  { id: 'claude-opus', name: 'Claude Opus 4.5', modelId: MODEL_IDS['claude-opus'], systemPrompt: BASE_SYSTEM_PROMPT },
  { id: 'gemini-pro', name: 'Gemini 3 Pro', modelId: MODEL_IDS['gemini-pro'], systemPrompt: BASE_SYSTEM_PROMPT },
  { id: 'grok', name: 'Grok 4', modelId: MODEL_IDS['grok'], systemPrompt: BASE_SYSTEM_PROMPT },
  { id: 'deepseek', name: 'Deepseek V3.2', modelId: MODEL_IDS['deepseek'], systemPrompt: BASE_SYSTEM_PROMPT },
];
